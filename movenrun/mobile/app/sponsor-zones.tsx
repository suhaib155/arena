        ...
        {overview.hasZones ? (
          <FadeSlideIn delay={STAGGER_MS * 3}>
            ...
            >
              ...
              <View style={styles.eventCtaBody}>
                <Text style={styles.eventCtaName}>Event Zones</Text>
                <Text style={styles.eventCtaNote}>Fictional future city activity · no live events</Text>
              </View>
