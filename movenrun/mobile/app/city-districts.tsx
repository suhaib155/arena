        ...
        {overview.hasZones ? (
          <FadeSlideIn delay={STAGGER_MS * 3}>
            ...
            >
              ...
              <View style={styles.rivalCtaBody}>
                <Text style={styles.rivalCtaName}>Sponsor Preview</Text>
                <Text style={styles.rivalCtaNote}>Fictional future sponsor activations · no ads</Text>
              </View>
              <Ionicons name="chevron-forward" size={16} color={colors.textFaint} />
            </ScalePress>
          </FadeSlideIn>
        ...
        {overview.hasZones ? (
          <FadeSlideIn delay={STAGGER_MS * 3}>
            ...
            >
              ...
              <View style={styles.rivalCtaBody}>
                <Text style={styles.rivalCtaName}>Club Presence</Text>
                <Text style={styles.rivalCtaNote}>Your local club command layer · preview</Text>
              </View>
              <Ionicons name="chevron-forward" size={16} color={colors.textFaint} />
            </ScalePress>
          </FadeSlideIn>
        ...
        {overview.hasZones ? (
          <FadeSlideIn delay={STAGGER_MS * 3}>
            ...
            >
              ...
              <View style={styles.rivalCtaBody}>
                <Text style={styles.rivalCtaName}>District Mastery</Text>
                <Text style={styles.rivalCtaNote}>Long-term local progress · no ownership</Text>
              </View>
              <Ionicons name="chevron-forward" size={16} color={colors.textFaint} />
            </ScalePress>
          </FadeSlideIn>
